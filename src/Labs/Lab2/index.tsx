...
wd-flex-grow-1">
                ...
                <div id="wd-bs-responsive-grids-4" >
...
bg-danger text-white">
                            <h3>Column C</h3>
                        </div><div className="col-12 col-md-6 col-xl-3
bg-success text-white">
                ...
                <div id="wd-bs-responsive-grids-2" >
                    <h2>Wide browser window shows 2 columns</h2>
                    <h3>Responsive grid system</h3>
                    <div className="row">
                ...
                <div id="wd-bs-responsive-grids-1" >
                    <h2>Wide browser window shows 1 column</h2>
                    <h3>Responsive grid system</h3>
                    <div className="row">
...
bg-success text-white">
                ...
                <div id="wd-bs-responsive-dramatic" >
                    <h2>Responsive grid system</h2>
                    <div className="row">
                        <div className="col-12 col-sm-6 col-md-4 col-lg-2 bg-warning">
                            <h4>1</h4>
                        </div>
                        <div className="col-12 col-sm-6 col-md-4 col-lg-2 bg-primary text-white">
                            <h4>2</h4>
                        </div>
                        <div className="col-12 col-sm-6 col-md-4 col-lg-2 bg-danger text-white">
                            <h4>3</h4>
                        </div>
                        <div className="col-12 col-sm-6 col-md-4 col-lg-2 bg-success text-white">
                            <h4>4</h4>
                        </div>
                        <div className="col-12 col-sm-6 col-md-4 col-lg-2 bg-warning">
                            <h4>5</h4>
                ...
                <div id="wd-bs-responsive-dramatic" >
                    <h2>Responsive grid system</h2>
                    <div className="row">
                        <div className="col-12 col-sm-6 col-md-3 col-lg-3 bg-warning">
                            <h4>1</h4>
                        </div>
                        <div className="col-12 col-sm-6 col-md-3 col-lg-3 bg-primary text-white">
                            <h4>2</h4>
                        </div>
                        <div className="col-12 col-sm-6 col-md-3 col-lg-3 bg-danger text-white">
                            <h4>3</h4>
                        </div>
                        <div className="col-12 col-sm-6 col-md-3 col-lg-3 bg-success text-white">
                            <h4>4</h4>
                        </div>
                    </div>
                    <div className="row">
                ...
                <div id="wd-bs-responsive-dramatic" >
                    <h2>Responsive grid system</h2>
                    <div className="row">
                        <div className="col-12 col-sm-4 col-md-4 col-lg-4 bg-warning">
                            <h4>1</h4>
                        </div>
                        <div className="col-12 col-sm-4 col-md-4 col-lg-4 bg-primary text-white">
                            <h4>2</h4>
                        </div>
                        <div className="col-12 col-sm-4 col-md-4 col-lg-4 bg-danger text-white">
                            <h4>3</h4>
                        </div>
                    </div>
                    <div className="row">
                        <div className="col-12 col-sm-4 col-md-4 col-lg-4 bg-success text-white">
                            <h4>4</h4>
                        </div>
                        <div className="col-12 col-sm-4 col-md-4 col-lg-4 bg-warning">
                            <h4>5</h4>
                ...
                <div id="wd-bs-responsive-dramatic" >
                    <h2>Responsive grid system</h2>
                    <div className="row">
                        <div className="col-12 col-sm-6 col-md-6 col-lg-6 bg-warning">
                            <h4>1</h4>
                        </div>
                        <div className="col-12 col-sm-6 col-md-6 col-lg-6 bg-primary text-white">
                            <h4>2</h4>
                        </div>
                    </div>
                    <div className="row">
                        <div className="col-12 col-sm-6 col-md-6 col-lg-6 bg-danger text-white">
                            <h4>3</h4>
                        </div>
                        <div className="col-12 col-sm-6 col-md-6 col-lg-6 bg-success text-white">
                            <h4>4</h4>
                        </div>
                    </div>
                    <div className="row">
