...
export default function TOC() {
    ...
    return (
        ...
        <li>
            <a href="https://github.com/friendtheend/kanbas-react-web-app" id="wd-github">
        ...
        //     </li>
        //     <li className="nav-item">
        //         <a id="wd-k" href="https://github.com/friendtheend/kanbas-react-web-app" className="nav-link">
        //             My GitHub 
        //         </a>
        //     </li>
        // </ul>
        <ul className="nav nav-pills" id="wd-toc">
            ...
            <li className="nav-item"><a id="wd-github" href="https://github.com/friendtheend/kanbas-react-web-app" target="_blank"
                className="nav-link">My GitHub: Yifeng Lu Section:3</a></li>
        </ul>
